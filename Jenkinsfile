    ...
    stage('Upload') {
          ...
          dir(''){
            ...
            withAWS(region:'us-east-1',credentials:'108383104151') {
                  ...
                  s3Delete(pathStyleAccessEnabled: true, bucket:'useast1-nlsn-mediaanalytics-emr', path:'script/jenkinstest/Jenkinsfile')
                  s3Delete(pathStyleAccessEnabled: true, bucket:'useast1-nlsn-mediaanalytics-emr', path:'script/jenkinstest_temp')
